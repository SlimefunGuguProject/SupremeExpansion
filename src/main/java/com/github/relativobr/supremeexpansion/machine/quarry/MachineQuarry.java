package com.github.relativobr.supremeexpansion.machine.quarry;
...
public class MachineQuarry {
  ...
  public static final ItemStack[] MACHINE_SUPREMENUGGETS_QUARRY = new ItemStack[]{
      new ItemStack(Cetrus.CETRUS_LUMIUM), new ItemStack(Components.THORNERITE),
      new ItemStack(Cetrus.CETRUS_LUMIUM),
      new ItemStack(SupremeCore.CORE_OF_NATURE), MachineQuarry.THORNIUM_QUARRY,
      new ItemStack(SupremeCore.CORE_OF_BLOCK),
      new ItemStack(SupremeCore.CORE_OF_LIFE), new ItemStack(SlimefunItems.NUCLEAR_REACTOR),
      new ItemStack(SupremeCore.CORE_OF_DEATH)};

  public static final ItemStack[] MACHINE_THORNIUM_QUARRY = new ItemStack[]{
      new ItemStack(Cetrus.CETRUS_LUMIUM), new ItemStack(Components.ALLOY_ADAMANTIUM),
      new ItemStack(Cetrus.CETRUS_LUMIUM),
      new ItemStack(Components.CRYSTALLIZER_MACHINE), MachineQuarry.DIAMOND_QUARRY,
      new ItemStack(Components.CRYSTALLIZER_MACHINE),
  ...
  public static final ItemStack[] MACHINE_DIAMOND_QUARRY = new ItemStack[]{
      new ItemStack(Cetrus.CETRUS_AQUA), new ItemStack(Components.ALLOY_TITANIUM),
      new ItemStack(Cetrus.CETRUS_AQUA),
      new ItemStack(Components.INDUCTOR_MACHINE), MachineQuarry.GOLD_QUARRY,
      new ItemStack(Components.INDUCTOR_MACHINE),
      new ItemStack(SlimefunItems.ELECTRIC_MOTOR),
      new ItemStack(SlimefunItems.HEATED_PRESSURE_CHAMBER),
      new ItemStack(SlimefunItems.ELECTRIC_MOTOR)};

  public static final ItemStack[] MACHINE_GOLD_QUARRY = new ItemStack[]{
      new ItemStack(Cetrus.CETRUS_LUX), new ItemStack(Components.ALLOY_AURUM),
      new ItemStack(Cetrus.CETRUS_LUX),
      new ItemStack(Components.CONVEYANCE_MACHINE), MachineQuarry.IRON_QUARRY,
      new ItemStack(Components.CONVEYANCE_MACHINE),
  ...
  public static final ItemStack[] MACHINE_IRON_QUARRY = new ItemStack[]{
      new ItemStack(Cetrus.CETRUS_VENTUS), new ItemStack(Components.ALLOY_IRIDIUM),
      new ItemStack(Cetrus.CETRUS_VENTUS),
      new ItemStack(Components.STAINLESS_MACHINE), MachineQuarry.COAL_QUARRY,
      new ItemStack(Components.STAINLESS_MACHINE),
      new ItemStack(SlimefunItems.ELECTRO_MAGNET),
      new ItemStack(SlimefunItems.IRON_GOLEM_ASSEMBLER),
      new ItemStack(SlimefunItems.ELECTRO_MAGNET)};

  public static final ItemStack[] MACHINE_COAL_QUARRY = new ItemStack[]{
      new ItemStack(Cetrus.CETRUS_IGNIS), new ItemStack(Components.ALLOY_PLATINUM),
      new ItemStack(Cetrus.CETRUS_IGNIS),
