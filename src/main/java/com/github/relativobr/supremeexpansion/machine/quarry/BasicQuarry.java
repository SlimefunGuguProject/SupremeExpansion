...
import com.github.relativobr.supremeexpansion.machine.generic.UtilMachine;
import com.github.relativobr.supremeexpansion.util.Energy;
import com.github.relativobr.supremeexpansion.util.InventoryRecipe;
...
public class BasicQuarry extends SlimefunItem implements EnergyNetComponent {
  ...
  public BasicQuarry(ItemGroup category, SlimefunItemStack iconMachine, ItemStack[] machine) {
  ...
  protected void showMachine(Player p, Block b) {
    ...
    final String infoSpeed = Energy.timePerItem((TICK_DELAY * delaySpeed) / 2);
  ...
  public BasicQuarry setEffect(boolean effect) {
    this.effect = effect;
    return this;
  }

  public BasicQuarry setDelaySpeed(int delaySpeed) {
