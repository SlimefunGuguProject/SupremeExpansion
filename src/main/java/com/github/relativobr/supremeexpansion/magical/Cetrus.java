...
public class Cetrus {
  ...
  public static final SlimefunItemStack CETRUS_LUX = new SlimefunItemStack("CETRUS_LUX",
      "92cb6e51c461e7359526bea5e06209cddde7c6469a819f3405cf0a038c159502", "&a金行", "",
      "&7五行之一");
  public static final ItemStack[] RECIPE_CETRUS_LUX = {
      ...
      new ItemStack(Material.CAMPFIRE, 64), new SlimefunItemStack(SupremeCore.CORE_OF_LIFE, 1),
  ...
  public static final ItemStack[] RECIPE_CETRUS_LUMIUM = {
      new ItemStack(Material.DIRT, 64), new SlimefunItemStack(SupremeCore.CORE_OF_BLOCK, 1),
  ...
  public static final SlimefunItemStack CETRUS_AQUA = new SlimefunItemStack("CETRUS_AQUA",
      "36161daa3589ec9c8187459ac36fd4dd2646c040678d3bfacb72a2210c6c801c", "&a水行", "",
      "&7五行之一");
  public static final ItemStack[] RECIPE_CETRUS_AQUA = {
      ...
      new ItemStack(Material.COD, 64), new SlimefunItemStack(SupremeCore.CORE_OF_DEATH, 1),
