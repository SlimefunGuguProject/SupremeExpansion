...
public class SupremeCetrus {
  ...
  public static final ItemStack[] RECIPE_CETRUS_LUX = {
      new ItemStack(Material.FLINT, 64), new ItemStack(Material.GLOWSTONE, 64),
      new ItemStack(Material.TORCH, 64),
      new ItemStack(Material.CAMPFIRE, 64), new SlimefunItemStack(SupremeMainCore.CORE_OF_LIFE, 1),
  ...
  public static final ItemStack[] RECIPE_CETRUS_VENTUS = {
      new ItemStack(Material.FEATHER, 64), new ItemStack(Material.LEATHER, 64),
      new ItemStack(Material.CHORUS_FRUIT, 64),
      new ItemStack(Material.COBBLESTONE, 64), new SlimefunItemStack(SupremeMainCore.CORE_OF_NATURE, 1),
      new ItemStack(Material.SAND, 64),
      new ItemStack(Material.ARROW, 64), new ItemStack(Material.PHANTOM_MEMBRANE, 64),
  ...
  public static final ItemStack[] RECIPE_CETRUS_LUMIUM = {
      new ItemStack(Material.DIRT, 64), new SlimefunItemStack(SupremeMainCore.CORE_OF_BLOCK, 1),
      new ItemStack(Material.GRASS_BLOCK, 64),
      new SlimefunItemStack(SupremeMainCore.CORE_OF_LIFE, 1), new ItemStack(Material.OBSIDIAN, 64),
      new SlimefunItemStack(SupremeMainCore.CORE_OF_DEATH, 1),
      new ItemStack(Material.WITHER_SKELETON_SKULL, 64),
      new SlimefunItemStack(SupremeMainCore.CORE_OF_ALLOY, 1), new ItemStack(Material.NETHER_STAR, 64)
  };
  ...
  public static final ItemStack[] RECIPE_CETRUS_AQUA = {
      new ItemStack(Material.ICE, 64), new ItemStack(Material.LILY_PAD, 64),
      new ItemStack(Material.SALMON, 64),
      new ItemStack(Material.COD, 64), new SlimefunItemStack(SupremeMainCore.CORE_OF_DEATH, 1),
  ...
  public static final ItemStack[] RECIPE_CETRUS_IGNIS = {
      new ItemStack(Material.NETHERRACK, 64), new ItemStack(Material.BLAZE_ROD, 64),
      new ItemStack(Material.SOUL_SAND, 64),
      new ItemStack(Material.QUARTZ_BLOCK, 64), new SlimefunItemStack(SupremeMainCore.CORE_OF_BLOCK, 1),
      new ItemStack(Material.MAGMA_CREAM, 64),
      new ItemStack(Material.GUNPOWDER, 64), new ItemStack(Material.OBSIDIAN, 64),
