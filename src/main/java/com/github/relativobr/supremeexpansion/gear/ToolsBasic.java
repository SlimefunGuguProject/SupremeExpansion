...
public final class ToolsBasic {
  ...
  public static final ItemStack[] RECIPE_ADAMANTIUM_AXE = {
      SupremeComponents.ADAMANTIUM_PLATE, SupremeComponents.ADAMANTIUM_PLATE, null,
      SupremeComponents.ADAMANTIUM_PLATE, new ItemStack(Material.STICK), null,
  ...
  public static final ItemStack[] RECIPE_AURUM_AXE = {
      SupremeComponents.AURUM_PLATE, SupremeComponents.AURUM_PLATE, null,
      SupremeComponents.AURUM_PLATE, new ItemStack(Material.STICK), null,
      null, new ItemStack(Material.STICK), null
  };
  ...
  public static final ItemStack[] RECIPE_TITANIUM_AXE = {
      SupremeComponents.TITANIUM_PLATE, SupremeComponents.TITANIUM_PLATE, null,
      SupremeComponents.TITANIUM_PLATE, new ItemStack(Material.STICK), null,
      null, new ItemStack(Material.STICK), null
  };
