...
public class SupremeComponents {
  ...
  public static final ItemStack[] RECIPE_THORNIUM_BIT = {
      null, null, null,
      SupremeQuarry.THORNIUM_QUARRY, SupremeQuarry.UNIQUENUGGETS_QUARRY, null,
      null, null, null
  };
  ...
  public static final ItemStack[] RECIPE_ZIRCONIUM_PLATE = {
      ...
      SupremeCoreBlock.RESOURCE_CORE_DIORITE, SupremeCoreBlock.RESOURCE_CORE_DIORITE,
  ...
  public static final ItemStack[] RECIPE_AURUM_PLATE = {
      ...
      SupremeCoreBlock.RESOURCE_CORE_SAND, SupremeCoreBlock.RESOURCE_CORE_SAND, SupremeCoreBlock.RESOURCE_CORE_SAND,
      new ItemStack(ALLOY_AURUM), new ItemStack(ALLOY_AURUM), new ItemStack(ALLOY_AURUM)
  };
  ...
  public static final ItemStack[] RECIPE_MANGANESE_PLATE = {
      ...
      SupremeCoreBlock.RESOURCE_CORE_GRANITE, SupremeCoreBlock.RESOURCE_CORE_GRANITE,
  ...
  public static final ItemStack[] RECIPE_PLATINUM_PLATE = {
      ...
      SupremeCoreBlock.RESOURCE_CORE_CLAY, SupremeCoreBlock.RESOURCE_CORE_CLAY, SupremeCoreBlock.RESOURCE_CORE_CLAY,
      new ItemStack(ALLOY_PLATINUM), new ItemStack(ALLOY_PLATINUM), new ItemStack(ALLOY_PLATINUM)
  };
  ...
  public static final ItemStack[] RECIPE_ADAMANTIUM_PLATE = {
      ...
      SupremeCoreBlock.RESOURCE_CORE_STONE, SupremeCoreBlock.RESOURCE_CORE_STONE, SupremeCoreBlock.RESOURCE_CORE_STONE,
      new ItemStack(ALLOY_ADAMANTIUM), new ItemStack(ALLOY_ADAMANTIUM),
      new ItemStack(ALLOY_ADAMANTIUM)
  };
  ...
  public static final ItemStack[] RECIPE_THORNERITE = {
      new ItemStack(SupremeComponents.THORNIUM_INGOT), new ItemStack(ALLOY_ADAMANTIUM),
  ...
  public static final ItemStack[] RECIPE_PETRIFIER_MACHINE = {
      new ItemStack(SupremeCoreAlloy.RESOURCE_CORE_COAL), new ItemStack(RUSTLESS_MACHINE),
      new ItemStack(SupremeCoreAlloy.RESOURCE_CORE_COAL),
      new ItemStack(ALLOY_ADAMANTIUM), new ItemStack(CARRIAGE_MACHINE),
      new ItemStack(ALLOY_ADAMANTIUM),
      new ItemStack(SupremeCoreBlock.RESOURCE_CORE_STONE), new ItemStack(INDUCTIVE_MACHINE),
      new ItemStack(SupremeCoreBlock.RESOURCE_CORE_STONE)
  };
  ...
  public static final ItemStack[] RECIPE_BLEND_MACHINE = {
      new ItemStack(INDUCTOR_MACHINE), new ItemStack(SupremeCoreAlloy.RESOURCE_CORE_DIAMOND),
      new ItemStack(INDUCTOR_MACHINE),
      new ItemStack(CRYSTALLIZER_MACHINE), new ItemStack(SupremeCoreAlloy.RESOURCE_CORE_EMERALD),
