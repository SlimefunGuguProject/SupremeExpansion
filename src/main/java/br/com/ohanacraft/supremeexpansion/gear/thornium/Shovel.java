...
public final class Shovel {
    ...
    public static final SlimefunItemStack THORNIUM_SHOVEL = new SlimefunItemStack("TOOLS_THORNIUM_SHOVEL",
    ...
    public static final SlimefunItemStack THORNIUM_SHOVEL_MAGIC = new SlimefunItemStack("TOOLS_THORNIUM_SHOVEL_MAGIC",
            Material.NETHERITE_SHOVEL, "&a&lMagic Shovel", "&f&lA Magic Shovel of Thornium");

    public static final SlimefunItemStack THORNIUM_SHOVEL_RARE = new SlimefunItemStack("TOOLS_THORNIUM_SHOVEL_RARE",
            Material.NETHERITE_SHOVEL, "&b&lRare Shovel", "&f&lA Rare Shovel of Thornium");

    public static final SlimefunItemStack THORNIUM_SHOVEL_EPIC = new SlimefunItemStack("TOOLS_THORNIUM_SHOVEL_EPIC",
            Material.NETHERITE_SHOVEL, "&d&lEpic Shovel", "&f&lA Epic Shovel of Thornium");

    public static final SlimefunItemStack THORNIUM_SHOVEL_LEGENDARY = new SlimefunItemStack("TOOLS_THORNIUM_SHOVEL_LEGENDARY",
            Material.NETHERITE_SHOVEL, "&6&lLegendary Shovel", "&f&lA Legendary Shovel of Thornium");

    public static final SlimefunItemStack THORNIUM_SHOVEL_SUPREME = new SlimefunItemStack("TOOLS_THORNIUM_SHOVEL_SUPREME",
