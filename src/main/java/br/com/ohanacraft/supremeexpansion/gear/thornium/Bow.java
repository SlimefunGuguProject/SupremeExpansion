...
import br.com.ohanacraft.supremeexpansion.resource.CoreDeath;
...
public final class Bow {
    ...
    public static final SlimefunItemStack THORNIUM_BOW_MAGIC = new SlimefunItemStack("WEAPONS_THORNIUM_BOW_MAGIC",
            Material.BOW, "&a&lMagic Bow", "&f&lA Magic Bow of Thornium");

    public static final SlimefunItemStack THORNIUM_BOW_RARE = new SlimefunItemStack("WEAPONS_THORNIUM_BOW_RARE",
            Material.BOW, "&b&lRare Bow", "&f&lA Rare Bow of Thornium");

    public static final SlimefunItemStack THORNIUM_BOW_EPIC = new SlimefunItemStack("WEAPONS_THORNIUM_BOW_EPIC",
            Material.BOW, "&d&lEpic Bow", "&f&lA Epic Bow of Thornium");

    public static final SlimefunItemStack THORNIUM_BOW_LEGENDARY = new SlimefunItemStack("WEAPONS_THORNIUM_BOW_LEGENDARY",
            Material.BOW, "&6&lLegendary Bow", "&f&lA Legendary Bow of Thornium");

    public static final SlimefunItemStack THORNIUM_BOW_SUPREME = new SlimefunItemStack("WEAPONS_THORNIUM_BOW_SUPREME",
