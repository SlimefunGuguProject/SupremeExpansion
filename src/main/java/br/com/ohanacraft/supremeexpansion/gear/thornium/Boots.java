...
public class Boots {
    ...
    public static final SlimefunItemStack THORNIUM_BOOTS = new SlimefunItemStack("ARMOR_THORNIUM_BOOTS",
    ...
    public static final SlimefunItemStack THORNIUM_BOOTS_MAGIC = new SlimefunItemStack("ARMOR_THORNIUM_BOOTS_MAGIC",
            Material.NETHERITE_BOOTS, "&a&lMagic Boots", "&f&lA Magic boots of Thornium");

    public static final SlimefunItemStack THORNIUM_BOOTS_RARE = new SlimefunItemStack("ARMOR_THORNIUM_BOOTS_RARE",
            Material.NETHERITE_BOOTS, "&b&lRare Boots", "&f&lA Rare boots of Thornium");

    public static final SlimefunItemStack THORNIUM_BOOTS_EPIC = new SlimefunItemStack("ARMOR_THORNIUM_BOOTS_EPIC",
            Material.NETHERITE_BOOTS, "&d&lEpic Boots", "&f&lA Epic boots of Thornium");

    public static final SlimefunItemStack THORNIUM_BOOTS_LEGENDARY = new SlimefunItemStack("ARMOR_THORNIUM_BOOTS_LEGENDARY",
            Material.NETHERITE_BOOTS, "&6&lLegendary Boots", "&f&lA Legendary boots of Thornium");

    public static final SlimefunItemStack THORNIUM_BOOTS_SUPREME = new SlimefunItemStack("ARMOR_THORNIUM_BOOTS_SUPREME",
