...
public class Helmet {
    ...
    public static final SlimefunItemStack THORNIUM_HELMET = new SlimefunItemStack("ARMOR_THORNIUM_HELMET",
    ...
    public static final SlimefunItemStack THORNIUM_HELMET_MAGIC = new SlimefunItemStack("ARMOR_THORNIUM_HELMET_MAGIC",
            Material.NETHERITE_HELMET, "&a&lMagic Helmet", "&f&lA Magic helmet of Thornium");

    public static final SlimefunItemStack THORNIUM_HELMET_RARE = new SlimefunItemStack("ARMOR_THORNIUM_HELMET_RARE",
            Material.NETHERITE_HELMET, "&b&lRare Helmet", "&f&lA Rare helmet of Thornium");

    public static final SlimefunItemStack THORNIUM_HELMET_EPIC = new SlimefunItemStack("ARMOR_THORNIUM_HELMET_EPIC",
            Material.NETHERITE_HELMET, "&d&lEpic Helmet", "&f&lA Epic helmet of Thornium");

    public static final SlimefunItemStack THORNIUM_HELMET_LEGENDARY = new SlimefunItemStack("ARMOR_THORNIUM_HELMET_LEGENDARY",
            Material.NETHERITE_HELMET, "&6&lLegendary Helmet", "&f&lA Legendary helmet of Thornium");

    public static final SlimefunItemStack THORNIUM_HELMET_SUPREME = new SlimefunItemStack("ARMOR_THORNIUM_HELMET_SUPREME",
