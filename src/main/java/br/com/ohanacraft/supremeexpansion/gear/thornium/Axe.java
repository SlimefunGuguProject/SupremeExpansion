...
public final class Axe {
    ...
    public static final SlimefunItemStack THORNIUM_AXE_MAGIC = new SlimefunItemStack("TOOLS_THORNIUM_AXE_MAGIC",
            Material.NETHERITE_AXE, "&a&lMagic Axe", "&f&lA Magic Axe of Thornium");

    public static final SlimefunItemStack THORNIUM_AXE_RARE = new SlimefunItemStack("TOOLS_THORNIUM_AXE_RARE",
            Material.NETHERITE_AXE, "&b&lRare Axe", "&f&lA Rare Axe of Thornium");

    public static final SlimefunItemStack THORNIUM_AXE_EPIC = new SlimefunItemStack("TOOLS_THORNIUM_AXE_EPIC",
            Material.NETHERITE_AXE, "&d&lEpic Axe", "&f&lA Epic Axe of Thornium");

    public static final SlimefunItemStack THORNIUM_AXE_LEGENDARY = new SlimefunItemStack("TOOLS_THORNIUM_AXE_LEGENDARY",
            Material.NETHERITE_AXE, "&6&lLegendary Axe", "&f&lA Legendary Axe of Thornium");

    public static final SlimefunItemStack THORNIUM_AXE_SUPREME = new SlimefunItemStack("TOOLS_THORNIUM_AXE_SUPREME",
