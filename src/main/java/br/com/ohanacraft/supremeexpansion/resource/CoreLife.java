...
public class CoreLife {
    ...
    public static final SlimefunItemStack RESOURCE_CORE_POTATO = new SlimefunItemStack("RESOURCE_CORE_POTATO",
    ...
    public static final SlimefunItemStack RESOURCE_CORE_APPLE = new SlimefunItemStack("RESOURCE_CORE_APPLE",
    ...
    public static final SlimefunItemStack RESOURCE_CORE_BEETROOT = new SlimefunItemStack("RESOURCE_CORE_BEETROOT",
    ...
    public static final SlimefunItemStack RESOURCE_CORE_WHEAT = new SlimefunItemStack("RESOURCE_CORE_WHEAT",
    ...
    public static final SlimefunItemStack RESOURCE_CORE_SUGAR_CANE = new SlimefunItemStack("RESOURCE_CORE_SUGAR_CANE",
            "8624bacb5f1986e6477abce4ae7dca1820a5260b6233b55ba1d9ba936c84b", "&aSupreme Sugar Cane", "", "&7A super sugar cane");
    ...
    public static final SlimefunItemStack RESOURCE_CORE_SWEET_BERRIES = new SlimefunItemStack("RESOURCE_CORE_SWEET_BERRIES",
    ...
    public static final SlimefunItemStack RESOURCE_CORE_MELON = new SlimefunItemStack("RESOURCE_CORE_MELON",
    ...
    public static final SlimefunItemStack RESOURCE_CORE_CARROT = new SlimefunItemStack("RESOURCE_CORE_CARROT",
    ...
    public static final SlimefunItemStack RESOURCE_CORE_PUMPKIN = new SlimefunItemStack("RESOURCE_CORE_PUMPKIN",
