...
public class ElectricCoreMachine extends MediumContainerMachine {
    ...
    public static final SlimefunItemStack ELECTRIC_CORE_MACHINE = new SlimefunItemStack("ELECTRIC_CORE_MACHINE",
            Material.SHROOMLIGHT, "&bElectric Core Machine",
            "", "&fCraft resource of core",
            "", LoreBuilder.machine(MachineTier.ADVANCED, MachineType.MACHINE), LoreBuilder.speed(1), Energy.energyPowerPerSecond(20));

    public static final ItemStack[] RECIPE_ELECTRIC_CORE_MACHINE = new ItemStack[] {
            Components.STAINLESS_MACHINE, SlimefunItems.ANDROID_MEMORY_CORE, Components.STAINLESS_MACHINE,
            Components.INDUCTOR_MACHINE, Components.BLEND_MACHINE, Components.INDUCTOR_MACHINE,
            SlimefunItems.ELECTRIC_MOTOR, SlimefunItems.CARBONADO_EDGED_CAPACITOR, SlimefunItems.ELECTRIC_MOTOR};

    public static final SlimefunItemStack ELECTRIC_CORE_MACHINE_II = new SlimefunItemStack("ELECTRIC_CORE_MACHINE_II",
            Material.SHROOMLIGHT, "&bElectric Core Machine II",
            "", "&fAdvanced craft resource of core",
            "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.MACHINE), LoreBuilder.speed(5), Energy.energyPowerPerSecond(100));
    ...
    public static final ItemStack[] RECIPE_ELECTRIC_CORE_MACHINE_II = new ItemStack[] {
            ...
            Components.INDUCTOR_MACHINE, ElectricCoreMachine.ELECTRIC_CORE_MACHINE, Components.INDUCTOR_MACHINE,
            Components.THORNERITE, Cetrus.CETRUS_IGNIS, Components.THORNERITE};

    public static final SlimefunItemStack ELECTRIC_CORE_MACHINE_III = new SlimefunItemStack("ELECTRIC_CORE_MACHINE_III",
            Material.SHROOMLIGHT, "&bElectric Core Machine III",
            "", "&fAdvanced craft resource of core",
            "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.MACHINE), LoreBuilder.speed(15), Energy.energyPowerPerSecond(300));
    ...
    public ElectricCoreMachine(Category category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    private static SimpleRecipe addRecipe(CustomCoreRecipe customCoreRecipe) {
        final ItemStack itemStack1 = new ItemStack(customCoreRecipe.getMainItem(), customCoreRecipe.getMainItem().getMaxStackSize());
        final ItemStack itemStack2 = new ItemStack(customCoreRecipe.getSecondItem(), customCoreRecipe.getSecondItem().getMaxStackSize());
        final ItemStack itemStack3 = new ItemStack(customCoreRecipe.getLastItem(), customCoreRecipe.getLastItem().getMaxStackSize());
